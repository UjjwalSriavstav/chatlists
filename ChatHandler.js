...
const chat_names = ["Ujjwal","Ravi", "Rahul", "Gopal", "Viggu", "Chandan", "Neeraj", "Jayant","Ankur"];
const chat_names_length = chat_names.length;
const chat_msg = ["hey buddy ,How are you :P ",
    "Oii, Ca 2 me kitne marks mile?.",
    "Ujjwal khelene chalega ?",
    "Assingment kr liya tune?",
    "Ujjwal bro i need your help",
    "thankyou Bhai"
];
